...
**Solution:**
*@\hspace{-0em}esquisse is a package that gives us the ability to create "ggplot2" figures interactively using available data frames.*
...
**Solution:**
*The Adelie and Chinstrap penguins are lighter in body mass compared to Gentoo which is the heaviest, but Adelie has a larger count.*
...
#| code-fold: FALSE
(IDs = rep(1:10, each = 3))
(Treatments = rep(c("Control", "Treatment A", "Treatment B"), times = 10))
```
